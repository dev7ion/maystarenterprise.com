        ...
        <div className="py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-4">
              ...
              <p className="text-white/50 leading-relaxed mb-8 text-sm max-w-sm">
            ...
            <div className="lg:col-span-2">
              <h4 className="text-white font-serif text-base font-bold mb-6 tracking-tight">Quick Links</h4>
            ...
            <div className="lg:col-span-3">
              <h4 className="text-white font-serif text-base font-bold mb-6 tracking-tight">Flagship Locations</h4>
            ...
            {/* Business Hours */}
            <div className="lg:col-span-3">
              <h4 className="text-white font-serif text-base font-bold mb-6 tracking-tight">Business Hours</h4>
              <ul className="space-y-4">
