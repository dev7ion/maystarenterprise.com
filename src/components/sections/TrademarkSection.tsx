    ...
    <section id="trademark" className="section-padding bg-gradient-to-b from-black via-gray-dark/20 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
            ...
            <div className="group relative bg-gray-dark/40 backdrop-blur-sm overflow-hidden rounded-xl hover-lift animate-slide-in-left">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-10">
                ...
                <h3 className="text-3xl lg:text-4xl font-serif font-bold text-white mb-3 group-hover:text-gold transition-colors">
                  May Star Hublife
                </h3>
                <p className="text-gold/90 text-sm mb-3 tracking-wide font-medium flex items-center gap-2">
                ...
                <p className="text-white/70 text-sm leading-relaxed border-l-2 border-gold/30 pl-4">
        ...
        <div className="max-w-5xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
          <div className="card-luxury p-8 lg:p-12 rounded-xl">
            ...
            <div className="grid sm:grid-cols-2 gap-8 lg:gap-10">
              <div className="space-y-4 group">
                <div className="flex items-center gap-3 pb-3 border-b border-gold/20">
                  ...
                  <h4 className="text-gold text-sm font-bold tracking-wider uppercase">Jakarta & Jabodetabek</h4>
                </div>
              ...
              <div className="space-y-4 group">
                <div className="flex items-center gap-3 pb-3 border-b border-gold/20">
                  ...
                  <h4 className="text-gold text-sm font-bold tracking-wider uppercase">West Java</h4>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-white/70 hover:text-white transition-colors group/item">
                    <div className="w-1.5 h-1.5 bg-gold/50 rounded-full mt-2 group-hover/item:bg-gold transition-colors" />
                    <span className="text-sm">May Star 23 Paskal, Bandung</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4 group">
                <div className="flex items-center gap-3 pb-3 border-b border-gold/20">
                  ...
                  <h4 className="text-gold text-sm font-bold tracking-wider uppercase">Central Java & Yogyakarta</h4>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3 text-white/70 hover:text-white transition-colors group/item">
                    <div className="w-1.5 h-1.5 bg-gold/50 rounded-full mt-2 group-hover/item:bg-gold transition-colors" />
                    <span className="text-sm">May Star Jogja City Mall</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4 group">
                <div className="flex items-center gap-3 pb-3 border-b border-gold/20">
                  ...
                  <h4 className="text-gold text-sm font-bold tracking-wider uppercase">East Java</h4>
                </div>
                <ul className="space-y-3">
